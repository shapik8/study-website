...
<body>
	...
	<div id="mainSection">
		<!--<table  style="width: 60%;margin-left: 320px " border="1" align="center">
			 <tr>
			 	<td><img style="width: 100px;height:150px" src="IMAGE/g1.jpg"></td>
			 	<td><img style="width: 100px;height:150px" src="IMAGE/g2.jpg"></td>
			 	<td><img style="width: 100px;height:150px" src="IMAGE/g3.png"></td>		 	
			 </tr>
			 <tr>
			 	<td><img style="width: 100px;height:150px" src="IMAGE/g4.jpg"></td>
			 	<td><img style="width: 100px;height:150px" src="IMAGE/g5.png"></td>
			 	<td><img style="width: 100px;height:150px" src="IMAGE/g6.png"></td>
			 </tr>
			 <tr>
			 	<td><img style="width: 100px;height:150px" src="IMAGE/g7.png"></td>
			 	<td><img style="width: 100px;height:150px" src="IMAGE/g8.png"></td>
			 	<td><img style="width: 100px;height:150px" src="IMAGE/g9.jpg"></td>
			 </tr>
		</table>-->
		<!-- Slideshow container -->
		<div class="slideshow-container">
		  ...
		  <div class="mySlides fade">
		    ...
		    <div class="text">Wallpaper 1</div>
		  </div>

		  <div class="mySlides fade">
		    <div class="numbertext">2 / 3</div>
		    <img src="IMAGE/bg2.jpg" style="width:100%">
		    <div class="text">Wallpaper 2</div>
		  </div>

		  <div class="mySlides fade">
		    <div class="numbertext">3 / 3</div>
		    <img src="IMAGE/bg4.jpg" style="width:100%">
		    <div class="text">Wallpaper 3</div>
		  </div>
